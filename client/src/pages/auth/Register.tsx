...
function RegisterPage() {
	...
	return (
		<div className="min-h-screen flex justify-center py-8 bg-green-100">
			<main>
				<form
					className="w-[90vw] md:w-[600px] md:shadow-box rounded-lg p-2 md:p-8 flex flex-col gap-4 text-base bg-white"
